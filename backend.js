...
app.get('/api/files', async (req, res) => {
  try {
    ...
    if (response.ok) {
      ...
      res.status(response.status).json({ error: 'Failed to fetch files' });
    }
  } catch (error) {
...
app.post('/api/files/upload', async (req, res) => {
  try {
    ...
    if (response.ok) {
      ...
      res.status(response.status).json({ error: 'Failed to upload file', details: errorData });
    }
  } catch (error) {
...
app.post('/api/files/search', async (req, res) => {
  try {
    ...
    if (response.ok) {
      ...
      res.status(response.status).json({ error: 'Failed to search files', details: errorData });
    }
  } catch (error) {
...
app.delete('/api/files/:fileId', async (req, res) => {
  try {
    ...
    if (response.ok) {
      ...
      res.status(response.status).json({ error: 'Failed to delete file', details: errorData });
    }
  } catch (error) {
